      ...
      it('should return one board by boardId', () => {
        return queries.getBoardById(101).then( board => {
          expect(board).to.eql({
            ...
            cards: [
              { id: 80, board_id: 101, list_id: 40, content: 'card1', archived: false, order: 0},
              { id: 81, board_id: 101, list_id: 40, content: 'Card2', archived: false, order: 1},
              { id: 82, board_id: 101, list_id: 41, content: 'card3', archived: false, order: 0},
              { id: 83, board_id: 101, list_id: 41, content: 'Card4', archived: false, order: 1},
            ],
          })
        })
      })
