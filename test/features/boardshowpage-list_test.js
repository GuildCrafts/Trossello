    ...
    usingSelenium(()=> {
      ...
      describe('when a user is logged in', ()=> {
        it('can click on a previously existing list header and edit the header name', function(done){
          ...
          this.browser.wait(until.elementLocated(By.xpath('//div[@class="BoardShowPage-ListHeader" and ./div[contains(.,"New List1")]]')), 2000)
        ...
        it('can create a new list', function(done){
          ...
          this.browser.wait(until.elementLocated(By.xpath('//div[@class="BoardShowPage-ListHeader" and ./div[contains(.,"List3")]]')), 2000)
          this.browser.then(_ => done())
        })
        ...
        it('can copy a list using the list popover menu', function(done){
          ...
          this.browser.wait(until.elementLocated(By.xpath('//div[@class="BoardShowPage-ListHeader" and ./div[contains(.,"Copy List 1")]]')), 2000)
          this.browser.then(_ => done())
        })
      })
    })
